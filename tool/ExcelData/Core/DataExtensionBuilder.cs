...
#pragma warning restore S3264 // Events should be invoked
    ...
    private static string ConvertObjectValToCSharpType(object rowValue, DbType colType, string nativeType)
    {
        return rowValue.ToString() == "NULL"
            ? "NULL"
            : colType switch
        {
#pragma warning disable S3358 // Ternary operators should not be nested
            DbType.Binary => nativeType == "varbinary" ? $"\"{rowValue}\".ToCharArray().Select(c => (byte)c).ToArray()" : $"BitConverter.GetBytes(Convert.ToUInt64({rowValue}))",
